 ...
 * @author Xuantong
 */
public class MoreTypePageController implements Initializable {
    ...
    private ObservableList<String> moreType = FXCollections.observableArrayList();
    ...
    private void getComboBoxValue(){
        db.fillTypeCombo(moreType);
        moreComboValue.setValue("More Category");
        moreComboValue.setItems(moreType);
    }
    
    @FXML
    private void handleDisplayDataAction(ActionEvent event){
        getBookData();
    }
